 ...
 * }
 */
function crearPersona(_nombre, _apellido, _edad, _documento) {
    return persona = {
        nombre : _nombre,
        apellido : _apellido,
        edad : _edad,
 ...
 */
function agregarApodo(_persona, _apodo) {
 ...
 */
function sinDocumento(_persona) {
    let persona = {..._persona};
 ...
 */
function tieneDocumento(_persona) {
    let persona = {..._persona};
 ...
 */
function felizCumpleaños(_persona) {
    let persona = {..._persona};
    persona.edad += 1;
    return persona;
}
