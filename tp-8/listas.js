...
console.log("crearListaDeNumeros(5,2): ", crearListaDeNumeros(5,2));
...
console.log("encontrarPalabraMasCorta(['abc','abc', 'a','b', 'ab']): ", encontrarPalabraMasCorta(['abc','abc', 'a','b', 'ab']));
